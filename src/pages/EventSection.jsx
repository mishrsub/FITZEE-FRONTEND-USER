            ...
            <div className="course-style-filter clearfix">
              <ul className="float-left clearfix">
                <li>
                  <Link
                    to="#"
                    className={`tran3s ${filter === "" ? "active" : ""}`}
                    onClick={() => filterData("")}
                  >
                    This Week
                  </Link>
                ...
                <li>
                  <Link
                    to="#"
                    className={`tran3s ${filter === "paid" ? "active" : ""}`}
                ...
                <li>
                  <Link
                    to="#"
                    className={`tran3s ${filter === "free" ? "active" : ""}`}
                ...
                <div className="event" key={val._id}>
                  <div className="event-left">
                    <div className="event-date">
                      ...
                      <div className="month">Jan 2024</div>
                  ...
                  <div className="event-right">
                    <h3 className="event-title">{val.title}</h3>
                    <ul className="clearfix">
                      <li className="float-left">
                        <i className="flaticon-time" />{" "}
                        {new Date(val.timing).toLocaleDateString("en-US", {
                          day: "numeric",
                          month: "short",
                          year: "numeric",
                        })}
                      ...
                      <li className="float-left">
                        <i className="flaticon-placeholder" /> {val.address}
                      </li>
                      <li>
                        <span className="event-timing">{val.catalog}</span>
                      </li>
                    </ul>
                    <div className="event-description">{val.description}</div>
