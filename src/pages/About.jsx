...
const About = () => {
  useEffect(() => {
    ...
    const scriptsToLoad = [
      ...
      'src/assets/vendor/particles.js-master/demo/js/theme.js', 
        ...
        <div className="row">
          ...
          <div className="col-sm-6 col-xs-12">
            <div className="theme-title">
              <h2 style={{ fontSize: 36 }}>Chairman's Message</h2>
            </div>{" "}
            {/* /.theme-title */}
            <p className="space">
              ” This Journey from just an IIT-JEE Coaching Institute to the most
              powerful brand in serious education has been exhilarating.
              However, the Journey is not over yet. For us at FIITJEE, the
            ...
            <div className="title">
              <h4>Mr. D. K. Goel</h4>
              <span>(Founder Chairman &amp; Chief Mentor - FIITJEE Group)</span>
            </div>
          </div>
        </div>
      </div>{" "}
      ...
      <div className="row">
        ...
        <div className="col-xs-12 col-sm-4 col-md-4">
          <div className="single-box tran3s">
            ...
            <p>
              ...
              Leader In Education, both In Not For Profit as well as For Profit
              Ventures
            </p>
          </div>{" "}
          {/* /.single-box */}
        ...
        <div className="col-xs-12 col-sm-4 col-md-4">
          <div className="single-box tran3s">
            ...
            <p>
              FIITJEE values system revolves around truth, transparency &amp;
              commitment. Whatever we think, we say &amp; whatever we say, we
              do. We present to you what we actually are.
            </p>
          </div>{" "}
          {/* /.single-box */}
        </div>
