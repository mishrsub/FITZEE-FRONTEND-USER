              ...
              <div className="course-info row">
                ...
                <div className="col-xs-4">
                  <div>
                    ...
                    CLASS:
                    {data?.eligibleClass?.length>0 && data?.eligibleClass.map((val) => (
                      <b>{` ${val} |`}</b>
                    ))}
                  </div>
                </div>
                <div className="col-xs-4">
                  <div>
                    ...
                    <p>Subjects</p>
                    {data?.subjects?.length>0 && data?.subjects.map((val) => (
                      <b>{val} &amp; </b>
                    ))}
                  </div>
                </div>
...
<<<<<<< HEAD
              ...
              <h3 style={{ paddingTop: 35 }}>{data?.programBrief}</h3>
              ...
              <div className="curriculum-panel">
                <div className="panel-group theme-accordion" id="accordionTwo">
                  {data?.programPoint?.length>0 && data?.programPoint.map((val, i) => (
