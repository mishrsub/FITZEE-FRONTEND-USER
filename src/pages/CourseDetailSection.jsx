                        ...
                        <div className="col-md-8 col-xs-12">
                            <div className="details-wrapper">
                                <div className="course-title">
                                    ...
                                    <span>
                                        For Students Presently in Class V (Going
                                        to VI in the year 2024)
                                    </span>
                                </div>{" "}
                                {/* /.course-title */}
                                <div className="course-info row">
                                    ...
                                    <div className="col-xs-4">
                                        <div>
                                            ...
                                            <p>Subjects tought</p>
                                            <b>
                                                {getData?.subjectTaught
                                                    ?.length > 0 &&
                                                    getData?.subjectTaught.map(
                                                        (val) => `${val}, `
                                                    )}
                                            </b>
                                        </div>
                                    ...
                                    >
                                        <div className="main-wrapper">
                                            ...
                                            <div className="carousel-inner">
                                                {getData?.programDetailImg
                                                    ?.length > 0 &&
                                                    getData?.programDetailImg.map(
                                                        (val, index) => (
                                                            <div
                                                                key={val}
                                                                className={`item ${
                                ...
                                <h3 style={{ paddingTop: 35 }}>
                                    {getData?.programBrief}
                                </h3>
                                <p className="p1">
                                    {getData?.programDescription}
                                </p>
                                ...
                                <div className="course-feedback">
                                    ...
                                    {/* /.feedback-container */}
                                    {/* /.single-review */}
                                    {getData?.matchedSubprogram?.review
                                        ?.length > 0 &&
                                        getData?.matchedSubprogram?.review?.map(
                                            (val) => (
                                                <div
                                                    className="single-review clearfix"
                                                    key={val?.id}
                                                >
                                                    <img
                                                        src={Course30}
                      ...
                      <li class="float-right"><a href="#" class="tran3s"><i class="flaticon-like"></i></a></li>
                                    ...
                                    <ul className="info-list row">
                                        <li className="col-xs-6">
                                            <b>Phases :</b>{" "}
                                            {getData?.programSummary?.phases}
                                        </li>
                                        <li className="col-xs-6">
                                            <b>Duration :</b>{" "}
                                            {getData?.programSummary?.duration}
                                        </li>
                                        <li className="col-xs-12">
                                            <b>Hours :</b>{" "}
                                            {getData?.programSummary?.numOfHrs}
                                        </li>
                                        <li className="col-xs-12">
                                            <b>Rating :</b>
                                            <ul
                                ...
                                <div className="sidebar-instructor-info">
                                    <div className="wrapper sidebar-course-information">
                                        ...
                                        <ul class="info-list row">
                                            <li class="col-xs-6">
                                                <b>Date :</b>{" "}
                                                {getData?.batchStartDate?.date.slice(
                                                    0,
                                                    10
                                                )}
                                            </li>
                                            <li class="col-xs-6">
                                                <b>Day :</b>{" "}
                                                {getData?.batchStartDate?.day}
                                            </li>
                                            <li class="col-xs-6">
                                                <b>Center :</b>{" "}
                                                {
                                                    getData?.batchStartDate
                                                        ?.center
                                                }
                                            </li>
                                            <li class="col-xs-6">
                                                <b>Batch :</b>{" "}
                                                {getData?.batchStartDate?.batch}{" "}
                                            </li>
                                        </ul>
                                        <a
                                            href="#"
