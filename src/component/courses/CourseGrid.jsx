...
const CourseGrid = ({ course }) => {
  ...
  const convertRomanNumeral = romanNumeral => romanNumeral.replace(/(I|V|X|L|C|D|M)(?![IVXLCDM]|$)/g, '$1 ');
                    ...
                    <div className="single-course" key={programData._id}>
                      ...
                      <div className="text">
                        <div className="image">
                          ...
                          <LetterAvatar name={convertRomanNumeral(data.name)} size={60} />
                        </div>
                        <div className="name free clearfix">
                          <h6 className="float-left">Class {data.name}</h6>
                          <span className="p-bg-color float-right">
                            {programData.isPaid ? "Paid" : "Free"}
                          </span>
                        </div>
                        <h5>
                          <Link to={`/fiitjee_mumbai-v11/courses/class/${data._id}/program/${program._id}/subprogram/${programData._id}`}>
                          {/* <a href="course_details.php" className="tran3s"> */}
                            {truncateText(programData.name,5)}
                          {/* </a> */}
                          </Link>
                        </h5>
                    ...
                    <div id="collapse2" className="panel-collapse collapse">
                      <div className="panel-body">
                        <ul>
                          <li>
                            <a href="#" className="tran3s">
                              e-LITTLE GENIE little Genie-One Year Live Online
                              Foundation Program
                            </a>
                          </li>
                          <li>
              ...
              <div className="course-filter">
                ...
                <form action="#" className="main-wrapper">
                  <div className="tag-option">
                    ...
                    <ul className="clearfix">
                      <li>
                        <input type="checkbox" id="book" defaultChecked="" />
                        <label htmlFor="book">IIT</label>
                      </li>
                      <li>
                        <input type="checkbox" id="linux" />
                        <label htmlFor="linux">JEE</label>
                      </li>
                      <li>
                        <input type="checkbox" id="design" defaultChecked="" />
                        <label htmlFor="design">JEE Mains</label>
                      </li>
                      <li>
                        <input
                          type="checkbox"
                          ...
                          defaultChecked=""
                        />
                        <label htmlFor="development">JEE Advance</label>
                      </li>
                    </ul>
                  </div>{" "}
                  {/* /.tag-option */}
                  <div className="course-price-filter">
                    ...
                    <div className="pricetag">
                      <div className="float-left">
                        ...
                        <label htmlFor="remember">Free</label>
                      </div>
                      <div className="float-left" style={{ marginLeft: 20 }}>
                        <input type="checkbox" id="remember" />
                        <label htmlFor="remember">Paid</label>
                      </div>
                    </div>
                  </div>{" "}
                  {/* /.course-price-filter */}
