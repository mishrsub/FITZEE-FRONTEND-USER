                    ...
                    <div className="single-course">
                      ...
                      <div className="text">
                        <div className="image">
                          ...
                          <img
                            src={LetterAvatar(
                              convertRomanToSpaced(data.name),
                              60
                            )}
                            alt=""
                          />
                        ...
                        <h5>
                          <Link
                            to={`/fiitjee_mumbai-v22/courses/class/${data._id}/program/${program._id}/subprogram/${programData._id}`}
                          >
                      ...
                      <div className="panel" key={i}>
                        ...
                        >
                          <h6 className="panel-title">
                            <a
                              ...
                              href={`#collapse${i + 1}`} // Unique href for each panel
                            >
                              {val?.name}
                            </a>
                          </h6>
                        ...
                        >
                          {val.subprograms.length > 0 &&
                            val.subprograms.map((subVal, j) => (
                              <div className="panel-body" key={j}>
                                <ul>
                                  <li>
                                    <Link
                                      to={`/fiitjee_mumbai-v22/courses/class/${data._id}/program/${val._id}/subprogram/${subVal._id}`}
                                      className="tran3s"
                                    >
                                      {subVal.name}
                                    </Link>
                  ...
                  <div className="tag-option">
                    ...
                    <ul className="clearfix">
                      <li>
                        ...
                        <label htmlFor="book">ANMC</label>
                      </li>
                      <li>
                        <input type="checkbox" id="linux" />
                        <label htmlFor="linux">VVM</label>
                      </li>
                      <li>
                        <input type="checkbox" id="design" defaultChecked="" />
                        <label htmlFor="design">NMTC</label>
                      </li>
                      <li>
                        <input
                          type="checkbox"
                          ...
                          defaultChecked=""
                        />
                        <label htmlFor="development">Homi Bhabha</label>
                      </li>
                      <li>
                        <input type="checkbox" id="development" />
                        <label htmlFor="development">IPM</label>
                      </li>
                      <li>
                        <input type="checkbox" id="development" />
                        <label htmlFor="development">JMO</label>
                      </li>
                    </ul>
                  </div>{" "}
                  {/* /.tag-option */}
