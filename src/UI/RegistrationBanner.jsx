        ...
        switch (step) {
                ...
                return (
                    <>
                        ...
                        <label htmlFor="html" className="form-check-label">
                            I authorise FIITJEE to Connect, send information
                            time to time via SMS, Call/ Robocall (Automated
                            Call), WhatsApp or E-mail and I agree to FIITJEE’S
                            Privacy Policy (Click link on Privacy Policy to
                            Read).
                        </label>
                        {/* </div> */}
                        <button
            ...
            case 3:
                return (
                    <>
                        <h4>
                            Quick Registration Form (Please fill your details
                            below)
                        </h4>
                        <br />
                        <h6>
                ...
                return (
                    <div>
                        <center>
                            ...
                            <h6>
                                your message have been successfully submitted
                            </h6>
                        </center>
                        <br />
                                ...
                                <div>
                                    <ol className="step">
                                        <li className="wow delay1 fadeInUp">
                                            ...
                                            <div className="descr">
                                                Register for a FIITJEE Admission
                                                test
                                            </div>
                                        </li>
                                        <li className="wow delay2 fadeInUp">
                                            ...
                                            <div className="descr">
                                                Give the test with the best of
                                                your abilities
                                            </div>
                                        </li>
